...
def processCommand(c):
    if "open google" in c.lower():
        ...
        speak("Opening Yoututbe, What you want to watch?")
        rec = sr.Recognizer()
        ...
        try:
            ...
            # Recognize the video name from speech
            video_q = rec.recognize_google(audio)
            print(f"You said: {video_q}")
            
            video_query = video_q.replace(" ", "+")
    ...
    # Read headlines (limit to 5 articles)
        ...
        speak("Do you want to use AI for this?")
        rec = sr.Recognizer()
